...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Minority-owned tax preparation, planning & resolution in Hackensack, NJ. Fast, accurate filings with the maximum refund — backed by a decade of expertise." },
    ],
    links: [
